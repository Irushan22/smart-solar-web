...
export const Navbar = () => {
  ...
  return (
    <nav className={`${styles.navbar} ${isScrolled ? styles.navbarScrolled : ''}`} aria-label="Main navigation">
        ...
        <div className={styles.topBarContent}>
          ...
          <div className={styles.socialIcons}>
            ...
            {siteConfig.social.linkedin && (
              <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="LinkedIn">
                <LinkedinIcon />
              </a>
            )}
            {siteConfig.social.youtube && (
              <a href={siteConfig.social.youtube} target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="YouTube">
                <YoutubeIcon />
              </a>
            )}
          </div>
        ...
        <div className={styles.rightContent}>
          <div className={styles.navLinks}>
            {navLinks.map((link) => (
              <Link
                key={link.section}
                href={link.section === 'home' ? '/' : `#${link.section}`}
                className={`${styles.link} ${activeLink === link.section ? styles.active : ''}`}
      ...
      <div className={`${styles.mobileOverlay} ${isMobileMenuOpen ? styles.mobileOverlayOpen : ''}`}>
        {navLinks.map((link) => (
          <Link
            key={link.section}
            href={link.section === 'home' ? '/' : `#${link.section}`}
            className={`${styles.mobileLink} ${activeLink === link.section ? styles.active : ''}`}
            onClick={(e) => handleNavClick(e, link.section)}
          >
            {link.label}
          </Link>
