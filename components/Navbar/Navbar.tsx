    ...
    <nav className={`${styles.navbar} ${isScrolled ? styles.navbarScrolled : ''}`} aria-label="Main navigation">
      <div className={styles.topBar}>
        <div className={styles.topBarContent}>
          ...
          <div className={styles.socialIcons}>
            ...
            <a href="https://www.youtube.com/@SmartSolarEnergyAndElectricals" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="YouTube">
      ...
      <div className={styles.container}>
        <Link href="/" className={styles.logoContainer}>
          <Image src="/smart-solar-logo.png" alt="Smart Solar Energy - Solar Panel Installation Company Sri Lanka" width={160} height={48} className={styles.logoImage} priority />
